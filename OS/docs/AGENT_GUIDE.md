...
Agents in SperaxOS are specialized AI assistants designed to handle specific tasks in DeFi, crypto, and Web3. This guide will help you create effective agents for the marketplace.
...
```json
{
  "systemRole": "You are a DeFi Yield Optimization Specialist focusing on the Sperax ecosystem.
...
"Explain the Sperax USDs mechanism"
```
...
- Review the [Prompt Engineering Guide](docs/PROMPTS.md)
