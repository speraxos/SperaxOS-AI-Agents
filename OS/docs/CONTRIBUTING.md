# Contributing to SperaxOS Agents

Thank you for contributing to the SperaxOS Agent Marketplace! This guide will help you submit high-quality agents.
...
```bash
# Fork and clone
git clone https://github.com/YOUR_USERNAME/sperax-ai-agents.git
cd sperax-ai-agents
...
- 💬 Join our [Discord Community](https://discord.gg/sperax)
- 🐛 Open an [Issue](https://github.com/speraxos/sperax-ai-agents/issues)
- 📧 Email: <agents@sperax.io>

## Recognition

Top contributors:

- Featured on SperaxOS homepage
