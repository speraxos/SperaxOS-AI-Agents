...
- **SperaxOS**: Best for using pre-built agents, DeFi/crypto focus, agent teams
...
## SperaxOS Marketplace

### How do I submit an agent to SperaxOS?

1. Fork the repository: github.com/speraxos/sperax-ai-agents
...
- **SperaxOS**: Depends on agent configuration
...
- **SperaxOS**: Depends on implementation
...
- **SperaxOS**: Yes (once in marketplace, anyone can use)
...
5. Platform (ChatGPT/Claude/SperaxOS)
