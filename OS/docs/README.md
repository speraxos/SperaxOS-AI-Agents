# 🤖 SperaxOS Agent Marketplace

> **Discover, customize, and deploy intelligent agents for DeFi, crypto, and Web3**

SperaxOS accesses this repository to display some of its many available agents in the marketplace. This is the agent index that powers the SperaxOS ecosystem with generual use AI agents for blockchain, trading, portfolio management, and automated DeFi workflows. (full crypto list released with SperaxOS)

## 🌟 What is SperaxOS Agent Marketplace?

The Agent Marketplace is your gateway to specialized AI agents designed for the crypto and DeFi ecosystem. Each agent brings unique capabilities:

- **DeFi Specialists**: Yield optimization, portfolio analysis, liquidity management
- **Trading Agents**: Market analysis, trading strategies, risk assessment
- **Blockchain Experts**: Smart contract analysis, security audits, transaction monitoring
- **Web3 Tools**: NFT analytics, DAO governance, protocol research

## 🚀 Quick Start

### Using Agents in SperaxOS

1. Open SperaxOS and navigate to the Agent Market
2. Browse or search for agents by category (DeFi, Trading, Development, etc.)
3. Click on an agent to view details and add it to your workspace
4. Start conversing with your specialized agent
...
SperaxOS automatically loads agents from this index. All agents support 18 languages through automated i18n.

## ✨ Key Features

### 🤝 Agent Teams

Create collaborative teams of specialized agents:

- **Multiple Perspectives**: Different agents contribute unique expertise
- **Coordinated Workflows**: Built-in host manages team conversations
- **Private Messaging**: Agents can coordinate seamlessly
- **Rich Templates**: Pre-configured teams for common use cases

**Example Use Cases:**

- **Sperax Ecosystem Analysis**: Multiple agents gather data through different tools and discuss value creation
- **DeFi Strategy**: Combine yield-optimizer, portfolio-analyzer, and risk-assessment agents
- **Problem Solving**: Multi-agent collaboration across different domains

### 🔍 Agent Discovery

- **Search**: Find agents by name, category, or capability
- **Grouping**: Organize agents by workflow or use case
- **Pinning**: Keep frequently used agents readily accessible
- **Smart Filtering**: Filter by tags, language, or functionality

### 🎨 Customization

Every agent can be customized:

- Adjust model parameters (temperature, top_p, reasoning_effort)
- Modify system prompts for specific needs
- Configure response style and depth
- Set up automated workflows

## 📦 Available Agents (505 Total)
...
- Tokenomics analysts
- DeFi education specialists
- Whitepaper analysts

[View Full Agent List →](https://sperax/)

## 🤖 Contributing an Agent

We welcome contributions! Submit your agent to expand the SperaxOS ecosystem.

### Submission Process

1. **Fork this repository**
2. **Create your agent** using the template in `/agents/template.json`
3. **Add translations** (optional - automated i18n workflow will generate them)
...
```json
{
  "author": "your-name",
  "config": {
    "systemRole": "Your agent's system prompt here..."
  },
...
- **Clear Purpose**: Agent should solve a specific problem
- **Well-Structured Prompts**: Follow our [Prompt Writing Guide](./docs/PROMPTS.md)
- **Appropriate Tags**: Help users discover your agent
- **Testing**: Verify agent works as intended before submission

Our automated i18n workflow will translate your agent into 18 languages:
🇺🇸 English・🇨🇳 简体中文・🇹🇼 繁體中文・🇯🇵 日本語・🇰🇷 한국어・🇩🇪 Deutsch・🇫🇷 Français・🇪🇸 Español・🇷🇺 Русский・🇸🇦 العربية・and more

## 📖 Documentation

- [Agent Creation Guide](./docs/AGENT_GUIDE.md) - How to design effective agents
- [Prompt Engineering](./docs/PROMPTS.md) - Write better system prompts
- [Model Parameters](./docs/MODELS.md) - Understanding temperature, top_p, etc.
- [Agent Teams](./docs/TEAMS.md) - Creating collaborative agent workflows
- [API Reference](./docs/API.md) - Using the agent index programmatically

## 🔗 Related Projects

- [SperaxOS](https://sperax.io) - The AI-powered DeFi operating system
- [Sperax Protocol](https://sperax.io) - $17M VC-backed DeFi infrastructure
